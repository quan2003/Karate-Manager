        ...
        <div className="role-cards">
          ...
          >
            <div className="role-icon">
              <div className="role-icon-badge admin-icon">
          ...
          >
            <div className="role-icon">
              <div className="role-icon-badge secretary-icon">
                <ClipboardPenLine size={38} strokeWidth={2.4} />
              </div>
            </div>
            <h2>Thư ký</h2>
            <p className="role-description">
          ...
          >
            <div className="role-icon">
              <div className="role-icon-badge coach-icon">
                <Dumbbell size={38} strokeWidth={2.4} />
              </div>
            </div>
